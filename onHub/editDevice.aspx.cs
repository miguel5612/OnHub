...
namespace airQ
{
    public partial class editDevice : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
               var pSQL = "UPDATE thing SET state = 0 WHERE deviceID = " + Request.QueryString["deviceIDArchiv"];
            ...
            if (Request.QueryString["deviceID"] != null & !Page.IsPostBack)
            {
                ...
                var pSQL = "SELECT * FROM thing WHERE deviceID = " + Request.QueryString["deviceID"];
        ...
        protected void btnEnviar_click(object sender, EventArgs e)
        {
            try
            {
                var pSQL = "UPDATE thing SET deviceName = '@deviceName', inTopic = '@inTopic', outTopic = '@outTopic', deviceActiv = @deviceActiv WHERE deviceID = @deviceID";

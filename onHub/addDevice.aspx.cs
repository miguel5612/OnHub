...
namespace airQ
{
    public partial class registerDevice : System.Web.UI.Page
    {
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            {
                String pSQL = "INSERT INTO thing ([deviceName], [creationDate], [state], [idUsr], [thingTyp], [inTopic], [outTopic]) VALUES ('@deviceName', '@deviceDateSubscription', @deviceActiv, @deviceUsrId, @deviceTyp, '@inTopic', '@outTopic')";
